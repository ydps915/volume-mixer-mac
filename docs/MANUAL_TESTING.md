...
11. **Status item** — Confirm the custom fader icon is present in the menu bar and opens the quick mixer. If macOS has no physical room for another status item, remove or hide another menu-bar item; macOS controls overflow placement. The Volume Mixer remains available from the Dock.
